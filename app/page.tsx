...
export default function HomePage() {
  ...
  return (
    <main className="homepage-main">
      ...
      {/* ===== PROFESSIONAL BANNER ===== */}
      <section className="mt-12">
        <div className="bg-gradient-to-r from-[var(--color-card)] to-[var(--color-bg)] dark:from-[var(--color-card)] dark:to-[var(--color-bg)] rounded-xl border border-[var(--color-border)] p-4 md:p-8 text-center">
          <div className="max-w-2xl mx-auto">
            <p className="text-sm md:text-lg text-[var(--color-text)] leading-relaxed opacity-80 whitespace-normal md:whitespace-nowrap">
              Like this design?{' '}
